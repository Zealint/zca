...
namespace MulAsm {
  ...
  /**
   * Умножение вектора u размером size на лимб v с прибавлением лимба c.
  ...
  /**
   * Умножение вектора v размером size на лимб w с прибавлением результата
   * к вектору u с тем же размером size. 
   * Результат в z. Память выделена заранее.
   * Вернуть перенос в старший лимб.
   */  
  ...
  /**
   * Умножение вектора v размером size на лимб w с вычитанием результата
   * из вектора u с тем же размером size. 
   * Результат в z. Память выделена заранее.
   * Вернуть заём из старшего лимба.
   */  
...
/**
 * Умножение вектора на лимб со сложением z = u + v*w.
...
/**
 * Умножение вектора на лимб с вычитанием z = u - v*w.
 * Ограничение: u >= v*w.
 * Возвращает true при удачном вычитании.
 * Память в z выделена заранее.
 */
